import { createStockController, getStockByIDController, getStockController, updateStockController, deleteStockController } from '@/controllers/stock.controller';
  ...
  export class StockRouter {
    ...
    private initializeRoutes(): void {
      this.router.post("/",this.authGuard.verifyToken, this.authGuard.superAdminGuard,this.createStockController.createStockController);
      ...
      this.router.delete('/:id',this.deleteStockController.deleteStockController,
      )
    }
