...
export class CategoriesRouter {
  ...
  private initializeRoutes(): void {
    this.router.post(
      ...
      this.createCategoriesController.createCategoriesController,
    );
    this.router.get('/', this.getCategoriesController.getCategoriesController);
    this.router.patch(
      '/:id',
      this.authGuard.verifyToken,
      this.authGuard.superAdminGuard,
      this.updateCategoriesController.updateCategoriesController,
    );
    this.router.delete(
      '/:id',
      this.authGuard.verifyToken,
      this.authGuard.superAdminGuard,
      this.deleteCategoriesController.deleteCategoriesController,
    );
  }
